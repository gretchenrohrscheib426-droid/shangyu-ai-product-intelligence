...
|Nine local V2 additions|[Recorded provenance](../code-provenance.json)|Original local additions with AI assistance, absent from frozen upstream|Owner permits this public portfolio; no additional general reuse/modification/commercial grant|Included source references; two receive documented citation URL hardening|
